...
public:
     ...
     */
    typedef touchgfx::meta::TypeList< DynamicGraph1View,
            touchgfx::meta::TypeList< DynamicGraphView,
            touchgfx::meta::TypeList< DynamicGraphMenuView,
            touchgfx::meta::TypeList< DynamicGraph2LinesView,
            touchgfx::meta::TypeList< DynamicGraphSlideMenuView,
            touchgfx::meta::TypeList< ButtonView,
            touchgfx::meta::TypeList< ScreenLogoView,
            touchgfx::meta::TypeList< BarChartView,
            touchgfx::meta::TypeList< RadioButtonSemaphoreView,
            touchgfx::meta::TypeList< RadioButtonSemaphoreNewView,
            touchgfx::meta::TypeList< WirelessIconView,
            touchgfx::meta::TypeList< StarView,
            touchgfx::meta::TypeList< StarFlexButtonIconView,
            touchgfx::meta::TypeList< DynamicGraphSliderYView,
            touchgfx::meta::Nil > > > > > > > > > > > > >
            > GeneratedViewTypes;
     ...
     */
    typedef touchgfx::meta::TypeList< DynamicGraph1Presenter,
            touchgfx::meta::TypeList< DynamicGraphPresenter,
            touchgfx::meta::TypeList< DynamicGraphMenuPresenter,
            touchgfx::meta::TypeList< DynamicGraph2LinesPresenter,
            touchgfx::meta::TypeList< DynamicGraphSlideMenuPresenter,
            touchgfx::meta::TypeList< ButtonPresenter,
            touchgfx::meta::TypeList< ScreenLogoPresenter,
            touchgfx::meta::TypeList< BarChartPresenter,
            touchgfx::meta::TypeList< RadioButtonSemaphorePresenter,
            touchgfx::meta::TypeList< RadioButtonSemaphoreNewPresenter,
            touchgfx::meta::TypeList< WirelessIconPresenter,
            touchgfx::meta::TypeList< StarPresenter,
            touchgfx::meta::TypeList< StarFlexButtonIconPresenter,
            touchgfx::meta::TypeList< DynamicGraphSliderYPresenter,
            touchgfx::meta::Nil > > > > > > > > > > > > >
    ...
    {
        app.gotoDynamicGraphSliderYScreenNoTransition();
    }
protected:
