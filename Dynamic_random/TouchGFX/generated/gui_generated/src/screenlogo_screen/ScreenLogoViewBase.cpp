    ...
    updateItemCallback(this, &ScreenLogoViewBase::updateItemCallbackHandler)
{
    ...
    textAreaYoutube.setPosition(343, 242, 144, 30);
    textAreaYoutube.setColor(touchgfx::Color::getColorFromRGB(240, 101, 14));
    textAreaYoutube.setLinespacing(0);
    textAreaYoutube.setTypedText(touchgfx::TypedText(T___SINGLEUSE_RYBS));
    textAreaYoutube.setAlpha(200);
    add(textAreaYoutube);

    textAreaGFX.setPosition(156, 68, 169, 53);
    textAreaGFX.setColor(touchgfx::Color::getColorFromRGB(36, 181, 176));
    textAreaGFX.setLinespacing(0);
    textAreaGFX.setTypedText(touchgfx::TypedText(T___SINGLEUSE_KRKJ));
    textAreaGFX.setAlpha(250);
    add(textAreaGFX);

    textAreaSTM32.setPosition(180, 21, 121, 53);
    textAreaSTM32.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textAreaSTM32.setLinespacing(0);
    textAreaSTM32.setTypedText(touchgfx::TypedText(T___SINGLEUSE_LHAH));
    textAreaSTM32.setAlpha(250);
    add(textAreaSTM32);
}
