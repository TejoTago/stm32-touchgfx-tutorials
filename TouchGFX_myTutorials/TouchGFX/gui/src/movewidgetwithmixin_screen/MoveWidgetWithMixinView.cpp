...

{
	...
	purpleBall.clearMoveAnimationEndedAction();
	purpleBall.startMoveAnimation(377, 46, 18, touchgfx::EasingEquations::bounceEaseOut, touchgfx::EasingEquations::bounceEaseOut);

	orangeBall.clearMoveAnimationEndedAction();
	orangeBall.startMoveAnimation(377, 96, 18, touchgfx::EasingEquations::linearEaseIn, touchgfx::EasingEquations::linearEaseIn);


	greenBall.clearMoveAnimationEndedAction();
	greenBall.startMoveAnimation(377, 147, 18, touchgfx::EasingEquations::bounceEaseIn, touchgfx::EasingEquations::bounceEaseIn);


	yellowBall.clearMoveAnimationEndedAction();
	yellowBall.startMoveAnimation(326, 75, 18, touchgfx::EasingEquations::linearEaseIn, touchgfx::EasingEquations::linearEaseIn);


	lightBlueBall.clearMoveAnimationEndedAction();
	lightBlueBall.startMoveAnimation(326, 126, 18, touchgfx::EasingEquations::linearEaseIn, touchgfx::EasingEquations::linearEaseIn);
