#include <gui/phase4_screen/Phase4View.hpp>
#include <touchgfx/Math3D.hpp>

Phase4View::Phase4View():
    pieChartClickedCallback(this, &Phase4View::pieChartClickHandler),
...
void Phase4View::setupScreen()
{
    Phase4ViewBase::setupScreen();
...
//
//    // Set Q1 as default on startup
//    updatePieChart(30, 70);  // Q1 data: Serie1=30%, Serie2=70%
    // Set initial center for all 6 series
    serie1.setCenter(originalCenterX, originalCenterY);
    serie2.setCenter(originalCenterX, originalCenterY);
    ...
    // Set Q1 as default on startup
    updatePieChart(15, 20, 25, 10, 18, 12);  // Q1 data totaling 100%
}

void Phase4View::tearDownScreen()
{
    Phase4ViewBase::tearDownScreen();
}

//void Phase4View::updateQuarterData()
//{
//    // Determine which radio button is selected
//    if (radioButtonQ1.getSelected())
//    {
//        // Q1: 30% / 70%
//        updatePieChart(30, 70);
//    }
//    else if (radioButtonQ2.getSelected())
//    {
//        // Q2: 45% / 55%
//        updatePieChart(45, 55);
//    }
//    else if (radioButtonQ3.getSelected())
//    {
//        // Q3: 60% / 40%
//        updatePieChart(60, 40);
//    }
//    else if (radioButtonQ4.getSelected())
//    {
//        // Q4: 25% / 75%
//        updatePieChart(25, 75);
//    }
//}
void Phase4View::updateQuarterData()
{
...
//void Phase4View::updatePieChart(int newSerie1Value, int newSerie2Value)
//{
...
//}
void Phase4View::updatePieChart(int s1, int s2, int s3, int s4, int s5, int s6)
{
    // Store new percentage values
    serie1Value = s1;
    serie2Value = s2;
...
//void Phase4View::pieChartClickHandler(const touchgfx::Container& src, const touchgfx::ClickEvent& evt)
//{
...
//int Phase4View::getClickedSlice(int16_t clickX, int16_t clickY)
//{
//    const int16_t centerX = 120;
//    const int16_t centerY = 120;
...
void Phase4View::moveSlice(touchgfx::Circle& slice, int arcStart, int arcEnd, bool moveOut)
{
    if (moveOut)
    {
...
void Phase4View::toggleAllSlices()
{
